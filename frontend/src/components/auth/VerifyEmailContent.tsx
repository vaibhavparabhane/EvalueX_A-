    ...
    <div className="min-h-screen bg-[#07090e] flex flex-col items-center justify-center px-4 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-lg z-10 bg-slate-950/40 border border-slate-900 backdrop-blur-xl p-8 md:p-12 rounded-[32px] shadow-2xl relative space-y-8">
        ...
        <div className="flex justify-center">
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold bg-primary/10 border border-primary/20 text-primary shadow-[0_0_15px_rgba(217,119,87,0.1)]">
        ...
        <div className="flex justify-center">
          <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-primary to-accent p-[1.5px] shadow-[0_8px_30px_rgba(79,70,229,0.2)] animate-bounce" style={{ animationDuration: '4s' }}>
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-400 text-sm md:text-base leading-relaxed max-w-sm mx-auto">
            ...
            {email ? (
              <span className="text-primary font-semibold underline decoration-primary/20 decoration-2 underline-offset-4">{email}</span>
            ) : (
        ...
        <div className="border-t border-slate-900 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-sm">
            <button
              ...
              className="text-primary hover:text-primary/95 font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
            >
              {resending ? (
                <>
